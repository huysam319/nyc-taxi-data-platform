...
command = shlex.split(
	env(
		"INGESTION_COMMAND",
		"/home/airflow/.local/bin/spark-submit --master spark://spark-master:7077 --driver-memory 4g --executor-memory 4g",
	)
)
...
args = [
	...
	"--quarantine-dir", env("INGESTION_QUARANTINE_DIR", "/storage/bronze/trip/_quarantine"),
